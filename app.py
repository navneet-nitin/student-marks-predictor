...
social_media = st.slider("Social Media Hours", 0.0, 10.0, 4.0,step=0.5)
netflix = st.slider("Netflix Hours", 0.0, 10.0, 1.0, step=0.5)
sleep = st.slider("Sleep Hours", 0.0, 12.0, 8.0,step=0.5)
